...
const Main = () => {
  ...
  const handleLogin = () => {
    ...
    if(formik?.values?.Email === sessionDetails?.email && formik?.values?.Password === sessionDetails?.Password){
      showNotification({
    ...
    <FormikProvider value={formik}>
      ...
      <section className={styles.formWrapper}>
        ...
        <form onSubmit={formik.handleSubmit}>
                <Field label="Email Address" name="Email" as={CustomFormInput} type="text" asterisk={false} />
                ...
                <Field
                 ...
                 asterisk={false}
                  as={CustomFormInput}
                   ...
                   text={formik?.values?.Password ===""? <></>: password ? <OpenEye className="passwordIcon"/> : <CloseEye className="passwordIcon"/>}
                ...
                <span className={styles.para2}>Don't have an account? <Link to="/sign-up" className={styles.signUpLink}> Sign Up</Link></span>
            </form>
